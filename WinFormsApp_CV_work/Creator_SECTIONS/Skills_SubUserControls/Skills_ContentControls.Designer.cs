...
{
    partial class Skills_ContentControls
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            SkillsRMV_tbx = new CuoreUI.Controls.cuiButton();
            MaleRadio = new RadioButton();
            SkillsDes_lb = new Label();
            Gender_lbl = new Label();
            SkillsDes_txb = new CuoreUI.Controls.cuiTextBox();
            SkillsName_txb = new CuoreUI.Controls.cuiTextBox();
            SkillsName_lb = new Label();
            cuiPanel2.SuspendLayout();
            SuspendLayout();
            // 
            // cuiPanel2
            // 
            cuiPanel2.Controls.Add(FemaleRadio);
            cuiPanel2.Controls.Add(SkillsRMV_tbx);
            cuiPanel2.Controls.Add(MaleRadio);
            cuiPanel2.Controls.Add(SkillsDes_lb);
            cuiPanel2.Controls.Add(Gender_lbl);
            cuiPanel2.Controls.Add(SkillsDes_txb);
            ...
            // SkillsRMV_tbx
            // 
            SkillsRMV_tbx.CheckButton = false;
            SkillsRMV_tbx.Checked = false;
            SkillsRMV_tbx.CheckedBackground = Color.FromArgb(255, 106, 0);
            SkillsRMV_tbx.CheckedForeColor = Color.White;
            SkillsRMV_tbx.CheckedImageTint = Color.White;
            SkillsRMV_tbx.CheckedOutline = Color.FromArgb(255, 106, 0);
            SkillsRMV_tbx.Content = "Remove";
            SkillsRMV_tbx.DialogResult = DialogResult.None;
            SkillsRMV_tbx.Font = new Font("Microsoft Sans Serif", 9.75F);
            SkillsRMV_tbx.ForeColor = Color.White;
            SkillsRMV_tbx.HoverBackground = Color.White;
            SkillsRMV_tbx.HoverForeColor = Color.Black;
            SkillsRMV_tbx.HoverImageTint = Color.White;
            SkillsRMV_tbx.HoverOutline = Color.FromArgb(32, 128, 128, 128);
            SkillsRMV_tbx.Image = null;
            ...
            SkillsRMV_tbx.NormalImageTint = Color.White;
            SkillsRMV_tbx.NormalOutline = Color.FromArgb(64, 128, 128, 128);
            SkillsRMV_tbx.OutlineThickness = 1F;
            SkillsRMV_tbx.PressedBackground = Color.WhiteSmoke;
            SkillsRMV_tbx.PressedForeColor = Color.FromArgb(32, 32, 32);
            ...
            SkillsRMV_tbx.Click += SkillsRMV_tbx_Click;
            // 
            // MaleRadio
            // 
            ...
            MaleRadio.UseVisualStyleBackColor = false;
            // 
            // SkillsDes_lb
            // 
            ...
            // SkillsDes_txb
            // 
            SkillsDes_txb.AutoSize = true;
            SkillsDes_txb.BackgroundColor = Color.FromArgb(245, 246, 255);
            SkillsDes_txb.Content = "";
            SkillsDes_txb.FocusBackgroundColor = Color.White;
            SkillsDes_txb.FocusImageTint = Color.White;
            SkillsDes_txb.FocusOutlineColor = Color.FromArgb(255, 106, 0);
            SkillsDes_txb.Font = new Font("Microsoft YaHei UI", 7.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            SkillsDes_txb.ForeColor = Color.FromArgb(30, 41, 57);
            ...
            // SkillsName_txb
            // 
            SkillsName_txb.BackgroundColor = Color.FromArgb(245, 246, 255);
            SkillsName_txb.Content = "";
            SkillsName_txb.FocusBackgroundColor = Color.White;
            SkillsName_txb.FocusImageTint = Color.White;
            SkillsName_txb.FocusOutlineColor = Color.FromArgb(255, 106, 0);
            SkillsName_txb.Font = new Font("Microsoft YaHei UI", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
            SkillsName_txb.ForeColor = Color.FromArgb(30, 41, 57);
        ...
        private CuoreUI.Controls.cuiButton SkillsRMV_tbx;
        private Label SkillsDes_lb;
        private CuoreUI.Controls.cuiTextBox SkillsDes_txb;
        private CuoreUI.Controls.cuiTextBox SkillsName_txb;
        private Label SkillsName_lb;
